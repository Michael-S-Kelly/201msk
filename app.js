...
console.log('ringName should return an undefined value ', ringName);
...
//for(var i = 1; i < 4 || numberGuess === randNumb; i++){
...
var ringName = prompt('Was my first dog\'s name, Fido?(y/Y/yes/Yes or no...').toLowerCase();


if (ringName === 'y' || ringName === 'yes'){
  alert('You are wrong, my first dog was named Sarah');
} else {
  alert('You are right, my first dog was named Sarah');
  score++;
...
console.log('ringName should return inputed value ' + ringName);
